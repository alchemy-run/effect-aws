  ...
  rules: [
    {
      ...
      rules: [
        {
          conditions: [
            { fn: "stringEquals", argv: [{ ref: "Region" }, "ap-northeast-1"] },
          ],
          endpoint: {
        ...
        {
          conditions: [
            { fn: "stringEquals", argv: [{ ref: "Region" }, "ap-south-1"] },
          ],
          endpoint: {
            url: "https://sts.amazonaws.com",
            properties: {
        ...
        {
          conditions: [
            { fn: "stringEquals", argv: [{ ref: "Region" }, "ap-southeast-1"] },
          ],
          endpoint: {
            url: "https://sts.amazonaws.com",
            properties: {
        ...
        {
          conditions: [
            { fn: "stringEquals", argv: [{ ref: "Region" }, "ap-southeast-2"] },
          ],
          endpoint: {
            url: "https://sts.amazonaws.com",
            properties: {
        ...
        {
          conditions: [
            { fn: "stringEquals", argv: [{ ref: "Region" }, "ca-central-1"] },
          ],
          endpoint: {
            url: "https://sts.amazonaws.com",
            properties: {
        ...
        {
          conditions: [
            { fn: "stringEquals", argv: [{ ref: "Region" }, "eu-central-1"] },
          ],
          endpoint: {
            url: "https://sts.amazonaws.com",
            properties: {
        ...
        {
          conditions: [
            { fn: "stringEquals", argv: [{ ref: "Region" }, "eu-north-1"] },
          ],
          endpoint: {
            url: "https://sts.amazonaws.com",
            properties: {
        ...
        {
          conditions: [
            { fn: "stringEquals", argv: [{ ref: "Region" }, "eu-west-1"] },
          ],
          endpoint: {
            url: "https://sts.amazonaws.com",
            properties: {
        ...
        {
          conditions: [
            { fn: "stringEquals", argv: [{ ref: "Region" }, "eu-west-2"] },
          ],
          endpoint: {
            url: "https://sts.amazonaws.com",
            properties: {
        ...
        {
          conditions: [
            { fn: "stringEquals", argv: [{ ref: "Region" }, "eu-west-3"] },
          ],
          endpoint: {
            url: "https://sts.amazonaws.com",
            properties: {
        ...
        {
          conditions: [
            { fn: "stringEquals", argv: [{ ref: "Region" }, "sa-east-1"] },
          ],
          endpoint: {
            url: "https://sts.amazonaws.com",
            properties: {
        ...
        {
          conditions: [
            { fn: "stringEquals", argv: [{ ref: "Region" }, "us-east-2"] },
          ],
          endpoint: {
            url: "https://sts.amazonaws.com",
            properties: {
        ...
        {
          conditions: [
            { fn: "stringEquals", argv: [{ ref: "Region" }, "us-west-1"] },
          ],
          endpoint: {
            url: "https://sts.amazonaws.com",
            properties: {
